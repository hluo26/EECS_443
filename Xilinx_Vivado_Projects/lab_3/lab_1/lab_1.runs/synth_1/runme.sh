...
HD_PWD='H:/EECS_443/Xilinx_Vivado_Projects/lab_1/lab_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1_1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source lab1_1.tcl
