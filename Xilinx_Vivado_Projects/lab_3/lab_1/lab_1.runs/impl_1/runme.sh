...
HD_PWD='H:/EECS_443/Xilinx_Vivado_Projects/lab_1/lab_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1_1.vdi -applog -m64 -messageDb vivado.pb -mode batch -source lab1_1.tcl -notrace
