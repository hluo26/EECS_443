...
HD_PWD='H:/EECS_443/Xilinx_Vivado_Projects/lab_2/project_2/project_2.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log FULL_ADDER.vdi -applog -m64 -messageDb vivado.pb -mode batch -source FULL_ADDER.tcl -notrace
