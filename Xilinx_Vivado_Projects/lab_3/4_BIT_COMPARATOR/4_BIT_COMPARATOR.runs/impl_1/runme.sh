...
HD_PWD='H:/EECS_443/Xilinx_Vivado_Projects/lab_2/4_BIT_COMPARATOR/4_BIT_COMPARATOR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log four_BIT_COMPARATOR.vdi -applog -m64 -messageDb vivado.pb -mode batch -source four_BIT_COMPARATOR.tcl -notrace
