...
HD_PWD='H:/EECS_443/Xilinx_Vivado_Projects/lab_4/8-to-3 Priority Encoder/8-to-3 Priority Encoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log priority_encoder.vdi -applog -m64 -messageDb vivado.pb -mode batch -source priority_encoder.tcl -notrace
