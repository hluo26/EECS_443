...
HD_PWD='H:/EECS_443/Xilinx_Vivado_Projects/lab_4/8-to-3 Priority Encoder/8-to-3 Priority Encoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log priority_encoder.vds -m64 -mode batch -messageDb vivado.pb -notrace -source priority_encoder.tcl
