...
set_property PACKAGE_PIN R7 [get_ports {S[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {S[2]}]
Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
set_property PACKAGE_PIN R6 [get_ports {S[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {S[3]}]
Bank = 34, Pin name = IO_L19N_T3_VREF_34,					Sch name = SW4
set_property PACKAGE_PIN R5 [get_ports {S[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {S[4]}]
Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = SW5
set_property PACKAGE_PIN V7 [get_ports {S[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {S[5]}]
Bank = 34, Pin name = IO_L20N_T3_34,						Sch name = SW6
set_property PACKAGE_PIN V6 [get_ports {S[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {S[6]}]
Bank = 34, Pin name = IO_L10P_T1_34,						Sch name = SW7
set_property PACKAGE_PIN V5 [get_ports {S[7]}]					
...
set_property PACKAGE_PIN V9 [get_ports {f[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {f[0]}]
Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
set_property PACKAGE_PIN R8 [get_ports {f[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {f[1]}]
Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = LED3
set_property PACKAGE_PIN T6 [get_ports {f[2]}]					
