...
HD_PWD='H:/EECS_443/Xilinx_Vivado_Projects/lab_4/8-to-1 Multiplexer/8-to-1 Multiplexer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux8to1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Mux8to1.tcl
