...
HD_PWD='H:/EECS_443/Xilinx_Vivado_Projects/lab_4/8-to-1 Multiplexer/8-to-1 Multiplexer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux8to1.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Mux8to1.tcl -notrace
