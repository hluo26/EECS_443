...
set_property PACKAGE_PIN R3 [get_ports {S[0]}]					
...
#set_property PACKAGE_PIN V9 [get_ports {W[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {W[1]}]
#Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
#set_property PACKAGE_PIN R8 [get_ports {W[2]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {W[2]}]
#Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = LED3
#set_property PACKAGE_PIN T6 [get_ports {W[3]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {W[3]}]
#Bank = 34, Pin name = IO_L12P_T1_MRCC_34,					Sch name = LED4
#set_property PACKAGE_PIN T5 [get_ports {W[4]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {W[4]}]
#Bank = 34, Pin name = IO_L12N_T1_MRCC_34,					Sch	name = LED5
#set_property PACKAGE_PIN T4 [get_ports {W[5]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {W[5]}]
#Bank = 34, Pin name = IO_L22P_T3_34,						Sch name = LED6
#set_property PACKAGE_PIN U7 [get_ports {W[6]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {W[6]}]
#Bank = 34, Pin name = IO_L22N_T3_34,						Sch name = LED7
#set_property PACKAGE_PIN U6 [get_ports {W[7]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {W[7]}]
