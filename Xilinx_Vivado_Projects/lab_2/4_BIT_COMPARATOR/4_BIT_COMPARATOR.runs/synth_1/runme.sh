...
HD_PWD='H:/EECS_443/Xilinx_Vivado_Projects/lab_2/4_BIT_COMPARATOR/4_BIT_COMPARATOR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log four_BIT_COMPARATOR.vds -m64 -mode batch -messageDb vivado.pb -notrace -source four_BIT_COMPARATOR.tcl
